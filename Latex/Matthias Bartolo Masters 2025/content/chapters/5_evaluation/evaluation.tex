...
Within this setup, a fixed random seed of 42, symbolically representing the "seed of life," was used, and all architectures were configured to employ deterministic algorithms. Several preliminary tests were carried out to verify that the results were consistent between runs. Minor variability in the reported results may still occur due to inherent non-deterministic operations on the GPU, but this was observed to be negligible, supporting the reliability of the findings.
...
\renewcommand{\arraystretch}{1.5} % increase row height by 30%
\begin{table}[htbp]
    \centering
    \small
...
To determine the optimal grid size, the elbow point \cite{elbow_point} method was applied. This approach involved calculating the first and second derivatives of the curve and identifying the point at which the rate of change begins to level off. The second derivative was essential in locating the inflection point, where diminishing returns set in.
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{training_times_soda_01m_dataset_binary_detection.jpg}
...
\begin{figure}[!t]
    \centering
    \includegraphics[width=1\textwidth]{training_times_soda_dataset_tiled_binary_detection.jpg}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{map_all_classes_soda_multi.jpg}
...
\begin{figure}[p]
  ...
  \begin{tabular}{c}
    ...
    \small (a) \\
    \addlinespace[1em]
    \includegraphics[width=0.7\textwidth]{cm2.png} \\
    \small (b) \\
  \end{tabular}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{training_times_soda_dataset_tiled_multi_label_detection.jpg}
...
The training durations for all models used in this experiment are shown in Figure~\ref{fig:soda_tiled_multi_training_time}. These results contrast significantly with those from the previous experiment (see Figure~\ref{fig:soda_tiled_single_training_time}). Overall, training times increased across the board. Notably, the student models required substantially more time to train compared to their baseline counterparts, marking a sharp rise relative to the earlier experiment.
...
\section{Object Size-Based Performance Analysis}
...
% Sliema Ghalik Marija, bil Grazzja Mimlija, IMbierka Inti u Imbierek il Frott tal Guf Tieghek Gesu', Qaddisa Marija Omm Alla Itlob ghalin il Midinbin, Issa u Fis Siegha tal mewt taghna. Amen. Grazzi
...
\begin{figure}[!htbp]
    \centering
    \includegraphics[width=1\textwidth]{map_all_classes_pascal_voc_no_text.jpg}
...
\begin{figure}[p]%!ht % p=Page of floats only
  \centering
  \begin{tabular}{c}
...
\begin{figure}[!ht]
    \centering
    \includegraphics[width=1\textwidth]{training_times_pascal_voc_2012_dataset_multi_label_detection_for_20_classes.jpg}
...
% Glorja lil Missier, u lil Iben u lil Ispirtu s-Santu, Kif kien mill bidu issa u ghal dejjem ta' dejjem. Amen. Grazzi hafna Mulej
...
\begin{figure}[!ht]
  ...
  \begin{tabular}{cc}
    ...
    \small (c) & \small (d) \\
    \addlinespace[1em]
    \includegraphics[width=0.47\textwidth]{visual13.jpg} &
    \includegraphics[width=0.47\textwidth]{visual14.jpg} \\
    \small (e) & \small (f) \\
  \end{tabular}
...
% Madonna Itlob Ghalina u Ddefendina, ghal Dejjem ta' Dejjem. Amen. Grazzi hafna
...
\begin{figure}[!b]% b = bottom of page
  \centering
  \begin{tabular}{ccc}
    \includegraphics[width=0.3\textwidth]{fail_case1.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case9.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case2.jpg} \\
    \small (a) & \small (b) & \small (c) \\[1em]
    
    \includegraphics[width=0.3\textwidth]{fail_case3.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case7.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case4.jpg} \\
    \small (d) & \small (e) & \small (f) \\[1em]
    
    \includegraphics[width=0.3\textwidth]{fail_case5.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case8.jpg} &
    \includegraphics[width=0.3\textwidth]{fail_case6.jpg} \\
...
% Glorja lil Missier, lil Iben u lil Ispirtu s-Santu, Kif kien mill-bidu issa u dejjem ta' dejjem. Amen.
...
In total, \textit{120} object detection models were trained and evaluated, which made it possible to conduct an ablation study on the \gls{alpha} parameter to identify optimal conditions for student model learning. Although the proposed approach leads to longer training times and some minor limitations in the privileged information generation, it does not impact the model size, the number of parameters, or the computational speed. As a result, lightweight models remain suitable, as they can deliver improved accuracy while maintaining efficiency during inference. Since inference is typically performed far more frequently than training in most deployment scenarios, this trade-off is both practical and worthwhile.
...
% Itlob Ghalina Mulej, Grazzi hafna. Amen
% Missierna li Inti fis Smewwiet, Jitqaddes Ismek, Tigi Saltanek, Ikun dak li trid into hekk fis Sema hekk da fl-art. Hobzna ta Kuljum, ghatina llum, Ahfrilna dnubietna bhal ma Nahfru lil Min Hu Hati' Ghalina, La ddahalniex fit tigrib izda ehslina mid deni. Amen, Grazzi ta' kollox.
