...
\newacronym[description={Region-based Fully Convolutional Network}]{rfcn}{R-FCN}{Region-based Fully Convolutional Network}
...
\newacronym[description=True Positive]{tp}{TP}{True Positives}
\newacronym[description=False Positive]{fp}{FP}{False Positives}
\newacronym[description=True Negative]{tn}{TN}{True Negatives}
\newacronym[description=False Negative]{fn}{FN}{False Negatives}
...
\newacronym[description=Small Objects from Different Altitudes]{soda}{SODA}{Small Objects from Different Altitudes}% (Dataset)
\newacronym[description=Joint Photographic Experts Group]{jpeg}{JPEG}{Joint Photographic Experts Group}
\newacronym[description=Kullback–Leibler]{kl}{KL}{Kullback–Leibler}
\newacronym[description=Joint Kernel Support Estimation]{jkse}{JKSE}{Joint Kernel Support Estimation}
...
\newacronym[description={Deformable Convolutional Networks}]{dcn}{DCNs}{Deformable Convolutional Networks}
...
\newacronym[description=Giga Floating Point Operations Per Second]{gflops}{GFLOPS}{Giga Floating Point Operations Per Second}
